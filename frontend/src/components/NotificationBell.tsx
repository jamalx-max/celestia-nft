      ...
      setNotifications([
        {
          ...
          type: 'sale',
          title: 'NFT Sold!',
          message: 'Your AuroraMint #42 was sold for 250 STX',
        ...
        },
        {
          ...
          message: 'You received an offer of 180 STX for AuroraMint #23',
        ...
        },
        {
          ...
          message: 'Someone placed a higher bid on AuroraMint #99',
        ...
        },
        {
          ...
          message: 'You successfully minted AuroraMint #156',
